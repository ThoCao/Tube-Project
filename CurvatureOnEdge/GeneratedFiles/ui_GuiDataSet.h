...
public:
    ...
    void setupUi(QWidget *GuiDataSet)
    {
        ...
        btn_savenewdata = new QPushButton(groupBox_2);
        btn_savenewdata->setObjectName(QStringLiteral("btn_savenewdata"));

        gridLayout_2->addWidget(btn_savenewdata, 1, 0, 1, 1);
    ...
    void retranslateUi(QWidget *GuiDataSet)
    {
        ...
        btn_savenewdata->setText(QApplication::translate("GuiDataSet", "Save New Data", 0));
